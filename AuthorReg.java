...
public class AuthorReg extends JFrame {
	...
	public AuthorReg() {
		...
		JLabel lblCoauthorEmails = new JLabel("Co-Author Email(s) :");
		lblCoauthorEmails.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblCoauthorEmails.setBounds(28, 539, 192, 36);
		contentPane.add(lblCoauthorEmails);
		
		JTextArea textArea_4 = new JTextArea();
		textArea_4.setFont(new Font("Monospaced", Font.PLAIN, 20));
		textArea_4.setBounds(220, 539, 472, 36);
		contentPane.add(textArea_4);
		
		JLabel lblTemporaryPassword = new JLabel("Author Password :");
		lblTemporaryPassword.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblTemporaryPassword.setBounds(28, 588, 208, 36);
		contentPane.add(lblTemporaryPassword);
		
		passwordField_2 = new JPasswordField();
		passwordField_2.setBounds(220, 591, 472, 36);
