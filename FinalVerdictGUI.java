...
public class FinalVerdictGUI extends Database {
	 ...
	 * Create the frame.
	 */
	public FinalVerdictGUI(int subId, int revX) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				addFinalVerdict(subId,revX, "StrongAccept");
			}
		});
		...
		btnStrongReject.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				addFinalVerdict(subId,revX, "StrongReject");
			}
		});
		...
		btnWeakAccept.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				addFinalVerdict(subId,revX, "WeakAccept");
			}
		});
		...
		btnWeakReject.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				addFinalVerdict(subId,revX, "WeakReject");
			}
		});
